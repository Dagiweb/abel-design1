...
export function getCategoryDisplay(tagOrCategory: string, language: Language = 'am'): string {
...
export function getCategoryShortDisplay(tagOrCategory: string, language: Language = 'am'): string {
  const clean = tagOrCategory.startsWith('#') ? tagOrCategory : `#${tagOrCategory}`;
  const found = CATEGORIES.find(
