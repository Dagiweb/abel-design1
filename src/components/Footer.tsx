...
export const Footer: React.FC<FooterProps> = ({ language, onSelectHashtag }) => {
  ...
  return (
    <footer className="bg-[#2D241E] text-[#FDFCF8] pt-14 pb-8 border-t-4 border-[#8B0000]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#FDFCF8]/60">
          <p>
